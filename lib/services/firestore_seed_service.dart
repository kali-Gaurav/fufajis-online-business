...
class FirestoreSeedService {
  ...
  List<Map<String, dynamic>> _getBaranGroceryProducts(String shopId) {
    ...
    products.addAll([
      ...
      p(
        id: 'rice_sona_masoori_5kg',
        name: 'Sona Masoori Rice 5kg',
        description: 'Medium grain sona masoori rice, ideal for daily cooking',
        price: 240,
        mrp: 265,
        category: 'groceries',
        unit: '5 kg',
      ...
      p(
        id: 'rice_local_5kg',
        name: 'Baran Local Rice 5kg',
        description: 'Fresh locally grown rice from Baran farms',
        price: 180,
        category: 'groceries',
        unit: '5 kg',
        stock: 100,
    ...
    products.addAll([
      p(
        ...
        description: 'Fresh whole wheat flour, ground daily, soft rotis guaranteed',
        price: 185,
        mrp: 200,
        category: 'groceries',
        unit: '5 kg',
      ...
      p(
        ...
        description: 'Premium whole wheat flour for daily chapati making',
        price: 340,
        mrp: 375,
        category: 'groceries',
        unit: '10 kg',
      ...
      p(
        id: 'maida_1kg',
        name: 'Maida 1kg',
        description: 'Refined flour for baking, pakoras, and puri',
        price: 42,
        category: 'groceries',
        unit: '1 kg',
        stock: 90,
      ...
      p(
        ...
        description: 'Fresh besan for pakora, kadhi, and sweets',
        price: 75,
        mrp: 82,
        category: 'groceries',
        unit: '1 kg',
    ...
    products.addAll([
      p(
        id: 'dal_arhar_1kg',
        name: 'Arhar Dal 1kg',
        description: 'Yellow pigeon peas, staple of every Indian kitchen',
        price: 140,
        mrp: 155,
        category: 'groceries',
        unit: '1 kg',
      ...
      p(
        id: 'dal_moong_1kg',
        name: 'Moong Dal 1kg',
        description: 'Split green gram, easy to digest and nutritious',
        price: 115,
        mrp: 130,
        category: 'groceries',
        unit: '1 kg',
      ...
      p(
        id: 'dal_masoor_1kg',
        name: 'Masoor Dal 1kg',
        description: 'Red lentils, quick cooking and protein-rich',
        price: 95,
        category: 'groceries',
        unit: '1 kg',
        stock: 120,
      ...
      p(
        id: 'dal_chana_1kg',
        name: 'Chana Dal 1kg',
        description: 'Split Bengal gram, perfect for dal and pakora',
        price: 85,
        category: 'groceries',
        unit: '1 kg',
        stock: 110,
      ...
      p(
        ...
        description: 'Dark red kidney beans from Jammu',
        price: 65,
        mrp: 75,
        category: 'groceries',
        unit: '500 g',
    ...
    products.addAll([
      p(
        ...
        description: 'Pure turmeric powder, bright yellow, high curcumin content',
        price: 45,
        mrp: 55,
        category: 'groceries',
        unit: '200 g',
      ...
      p(
        ...
        description: 'Hot red chilli powder from Rajasthan',
        price: 38,
        category: 'groceries',
        unit: '100 g',
        stock: 120,
        tags: ['spice', 'mirch', 'chilli'],
      ),
      p(
        id: 'dhaniya_200g',
        name: 'Dhaniya Powder 200g',
        description: 'Ground coriander seeds, fresh aroma',
        price: 35,
        category: 'groceries',
        unit: '200 g',
        stock: 130,
        tags: ['spice', 'dhaniya', 'coriander'],
      ),
      p(
        id: 'garam_masala_100g',
        name: 'Garam Masala 100g',
        description: 'Aromatic blend of whole spices, perfect for curries',
        price: 55,
        mrp: 65,
        category: 'groceries',
        unit: '100 g',
      ...
      p(
        id: 'jeera_100g',
        name: 'Jeera (Cumin Seeds) 100g',
        description: 'Whole cumin seeds, fragrant and fresh',
        price: 30,
        category: 'groceries',
        unit: '100 g',
        stock: 100,
    ...
    products.addAll([
      p(
        id: 'milk_toned_1l',
        name: 'Toned Milk 1L',
        description: 'Fresh pasteurized toned milk, 3% fat',
        price: 58,
        category: 'dairy',
        unit: '1 litre',
        stock: 200,
      ...
      p(
        ...
        description: 'Soft, fresh cottage cheese made daily',
        price: 72,
        category: 'dairy',
        unit: '200 g',
        stock: 50,
      ...
      p(
        id: 'dahi_500g',
        name: 'Dahi (Curd) 500g',
        description: 'Thick, creamy curd set overnight',
        price: 42,
        category: 'dairy',
        unit: '500 g',
        stock: 80,
        tags: ['dahi', 'curd', 'dairy'],
      ),
      p(
        id: 'ghee_500ml',
        name: 'Pure Cow Ghee 500ml',
        description: 'A2 milk pure desi ghee, slow churned',
        price: 325,
        mrp: 380,
        category: 'dairy',
        unit: '500 ml',
      ...
      p(
        ...
        description: 'Salted table butter, fresh and creamy',
        price: 56,
        mrp: 60,
        category: 'dairy',
        unit: '100 g',
    ...
    products.addAll([
      p(
        id: 'namkeen_bikaneri_200g',
        name: 'Bikaneri Bhujia 200g',
        description: 'Crispy gram flour noodles, Rajasthani favourite',
        price: 52,
        mrp: 60,
        category: 'snacks',
        unit: '200 g',
        stock: 120,
        isFeatured: true,
        tags: ['namkeen', 'bhujia', 'rajasthani'],
      ),
      p(
        id: 'chips_kurkure_75g',
        name: 'Kurkure 75g',
        description: 'Crunchy corn puffs in masala flavour',
        price: 20,
        category: 'snacks',
        unit: '75 g',
        stock: 200,
        tags: ['chips', 'kurkure', 'snack'],
        brand: 'Kurkure',
      ),
      p(
        id: 'biscuit_parle_g_100g',
    ...
    products.addAll([
      p(
        id: 'potato_1kg',
        name: 'Aalu (Potato) 1kg',
        description: 'Fresh potatoes from Baran farms',
        price: 22,
        category: 'vegetables',
        unit: '1 kg',
        stock: 300,
        isFeatured: true,
        tags: ['potato', 'aalu', 'vegetable'],
      ),
      p(
        id: 'onion_1kg',
        name: 'Pyaz (Onion) 1kg',
        description: 'Red onions, pungent and fresh',
        price: 28,
        category: 'vegetables',
        unit: '1 kg',
        stock: 250,
      ...
      p(
        ...
        description: 'Ripe red tomatoes, juicy and fresh',
        price: 35,
        category: 'vegetables',
        unit: '1 kg',
        stock: 200,
