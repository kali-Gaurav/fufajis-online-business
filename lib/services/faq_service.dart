...
class FaqService {
  ...
  Stream<List<FaqArticleModel>> watchAll() {
    return _col
        ...
        .snapshots()
        .map((snap) => snap.docs
            .map((d) => FaqArticleModel.fromMap(d.id, d.data()))
            .toList());
  }
  ...
  Future<void> add({
    ...
    await _col.add(FaqArticleModel(
      id: '',
  ...
  Future<FaqArticleModel?> findMatch(
    String message, {
    ...
    for (final article in articles) {
      ...
      final kTokens = article.keywords
          .expand((kw) => _tokenize(kw))
          .toSet();
  ...
  Future<void> seedDefaults() async {
    ...
    final defaults = <(String, String, String, List<String>, int)>[
      ...
      ('How do I track my order?',
       ...
       'Orders', ['track', 'tracking', 'where', 'order', 'status', 'delivery'], 10),
      ...
      ('Can I cancel my order?',
       ...
       'Orders', ['cancel', 'cancellation', 'stop', 'undo'], 11),
      ...
      ('Why was my order cancelled?',
       ...
       'immediately.',
       'Orders', ['cancelled', 'automatically', 'why', 'cancel', 'refund'], 12),
      ...
      ('What should I do if I received a wrong item?',
       ...
       'Orders', ['wrong', 'incorrect', 'item', 'received', 'mistake'], 13),
      ...
      ('What is the delivery time?',
       ...
       'Delivery', ['delivery', 'time', 'minutes', 'hours', 'fast', 'quick', 'long'], 20),
      ...
      ('Why is my delivery delayed?',
       ...
       'Delivery', ['delay', 'late', 'slow', 'stuck', 'waiting'], 21),
      ...
      ('My order shows "Delivered" but I didn\'t receive it.',
       ...
       'Delivery', ['delivered', 'missing', 'not received', 'lost', 'stolen'], 22),
      ...
      ('How do I get a refund?',
       ...
       'Payments', ['refund', 'money', 'back', 'return', 'wallet'], 31),
      ...
      ('Why was my payment charged twice?',
       ...
       'Payments', ['charged', 'double', 'twice', 'extra', 'deducted'], 32),
      ...
      ('The product I received was expired / damaged.',
       ...
       'Quality', ['expired', 'damaged', 'broken', 'stale', 'rotten', 'quality'], 40),
      ...
      ('Can I request a specific brand?',
       ...
       'Quality', ['brand', 'specific', 'request', 'product', 'stock'], 41),
      ...
      ('How do I change my delivery address?',
       ...
       'Account', ['address', 'change', 'update', 'location', 'profile'], 50),
      ...
      ('How do I delete my account?',
       ...
       'Account', ['delete', 'account', 'close', 'remove', 'data', 'GDPR'], 51),
      ...
      ('What is the return policy?',
       ...
       'Returns', ['return', 'policy', 'exchange', 'replace', '7 days'], 60),
      ...
      ('How do I initiate a return?',
       ...
       'Returns', ['return', 'initiate', 'how', 'start', 'exchange'], 61),
      ...
      ('How does the Fufaji Wallet work?',
       ...
       'Wallet', ['wallet', 'credits', 'balance', 'money', 'cashback'], 70),
      ...
      ('How do I contact customer support?',
       ...
       'General', ['contact', 'support', 'help', 'phone', 'call', 'helpline'], 80),
      ...
      ('Is Fufaji safe to order from?',
       ...
       'General', ['safe', 'trust', 'certified', 'quality', 'fresh', 'FSSAI'], 81),
    ];
