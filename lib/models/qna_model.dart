...
class QnaModel {
  ...
  factory QnaModel.fromMap(Map<String, dynamic> map) {
    return QnaModel(
      ...
      shopOwnerName: map['shopOwnerName'] as String?,
      createdAt: _parseTimestamp(map['createdAt']),
      answeredAt: _parseTimestamp(map['answeredAt']),
      helpfulVotes: map['helpfulVotes'] as int? ?? 0,
      unhelpfulVotes: map['unhelpfulVotes'] as int? ?? 0,
      helpfulVoters: List<String>.from(map['helpfulVoters'] as Iterable? ?? []),
      unhelpfulVoters: List<String>.from(map['unhelpfulVoters'] as Iterable? ?? []),
