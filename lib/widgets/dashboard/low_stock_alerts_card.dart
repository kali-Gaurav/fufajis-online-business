...
class LowStockAlertsCard extends StatefulWidget {
  ...
  const LowStockAlertsCard({super.key, this.shopId});
...
class _LowStockAlertsCardState extends State<LowStockAlertsCard> {
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(
                          criticalAlerts.isNotEmpty ? Icons.priority_high : Icons.warning_amber,
                          color: criticalAlerts.isNotEmpty ? AppTheme.error : AppTheme.warning,
                          size: 24,
                        ),
              ...
              if (criticalAlerts.isNotEmpty) ...[
                ...
                ...criticalAlerts.map((alert) => _buildAlertItem(alert, isCritical: true)),
              ],

              // Warning Alerts
              if (warningAlerts.isNotEmpty) ...[
                if (criticalAlerts.isNotEmpty) const Divider(height: 16),
                Padding(
                  padding: const EdgeInsets.fromLTRB(16, 16, 16, 8),
                  child: Text(
                ...
                ...warningAlerts.map((alert) => _buildAlertItem(alert, isCritical: false)),
              ],
  ...
  Widget _buildAlertItem(Map<String, dynamic> alert, {required bool isCritical}) {
        ...
        children: [
                      ...
                      children: [
                        ...
                        if (trend == 'increasing')
                          Container(
                            ...
                            child: const Row(
                              children: [
                                Icon(Icons.trending_up, size: 12, color: AppTheme.info),
                                SizedBox(width: 2),
                                Text(
                                  'Trending Up',
                                  style: TextStyle(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('in stock', style: TextStyle(fontSize: 10, color: AppTheme.grey600)),
                  ],
                ),
              ),
            ],
          ...
          Row(
            ...
            children: [
              ...
              const SizedBox(width: 8),
              Expanded(child: _buildMetricBadge('$dailyVelocity/d', 'Daily Sales', AppTheme.info)),
              const SizedBox(width: 8),
              Expanded(
                child: _buildMetricBadge('+$recommendedQuantity', 'Recommend', AppTheme.success),
              ),
            ],
          ),
        ],
  ...
  Widget _buildMetricBadge(String value, String label, Color color) {
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(label, style: const TextStyle(fontSize: 9, color: AppTheme.grey600)),
        ],
      ),
    );
  }
  ...
  void _showReorderDialog(BuildContext context, List<Map<String, dynamic>> alerts) {
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('PO created. Send to supplier via WhatsApp/Email')),
              );
            },
  ...
  void _showContactSupplierDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Send restocking request to your supplier through:'),
        actions: [
          TextButton(onPressed: () => Navigator.pop(context), child: const Text('Cancel')),
          TextButton(
            onPressed: () {
