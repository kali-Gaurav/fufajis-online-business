...
class _ProductSearchScreenState extends State<ProductSearchScreen> {
  ...
  Future<void> _performSearch(String query) async {
    ...
    try {
      ...
      final barcodeResult =
          await _searchService.searchByBarcode(widget.shopId, query);
      ...
      if (barcodeResult != null) {
        ...
        LoggingService().info(
          'ProductSearch: Barcode "$query" found in ${_lastSearchTimeMs}ms',
        );
        return;
      }
                ...
                : _searchResults.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final stockColor =
                              product.stockQuantity <= 0 ? AppTheme.error : AppTheme.success;
