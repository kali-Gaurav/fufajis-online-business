...
class WhatsAppSyncSetupScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('WhatsApp Inventory Sync', style: TextStyle(fontWeight: FontWeight.w700)),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildStep(
              ...
              description: 'Save +91 85298 41981 in your contacts as "Fufaji Inventory".',
      ...
      children: [
        Center(
          child: Container(
            ...
            child: const Icon(Icons.chat, size: 80, color: AppTheme.success),
          ),
        ),
        const SizedBox(height: 15),
        const Center(
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: () async {
          ...
          final url = Uri.parse("https://wa.me/918529841981?text=${Uri.encodeComponent(message)}");
