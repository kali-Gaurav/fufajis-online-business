          ...
          children: [
                ...
                QuickAction(
                  ...
                  onTap: () {
                    ScaffoldMessenger.of(
                      context,
                    ).showSnackBar(const SnackBar(content: Text('Add Branch Action')));
                  },
                ),
                QuickAction(
                  ...
                  onTap: () {
                    ScaffoldMessenger.of(
                      context,
                    ).showSnackBar(const SnackBar(content: Text('Global Purchase Action')));
                  },
                ),
                QuickAction(
                  ...
                  onTap: () {
                    ScaffoldMessenger.of(
                      context,
                    ).showSnackBar(const SnackBar(content: Text('Financials Action')));
                  },
            ...
            UniversalWorkQueueUI(
              ...
              onTaskAction: (task) {
                ScaffoldMessenger.of(
                  context,
                ).showSnackBar(SnackBar(content: Text('Intervening: ${task.title}')));
              },
            ),
          ],
        ),
