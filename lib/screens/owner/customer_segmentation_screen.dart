...
class _CustomerSegmentationScreenState extends State<CustomerSegmentationScreen>
  ...
  Future<void> _sendCampaign(BuildContext context, Map<String, dynamic> customer,
                ...
                Row(children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: chipColor, borderRadius: BorderRadius.circular(6)),
                    child: Text(chipLabel,
                        style: TextStyle(fontSize: 11, color: chipTextColor,
                            fontWeight: FontWeight.w600)),
                  ),
                  const SizedBox(width: 8),
                  Text('₹${(ltv as num).toStringAsFixed(0)} · $orders orders',
