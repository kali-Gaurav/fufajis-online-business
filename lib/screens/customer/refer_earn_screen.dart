...
/// Refer & Earn — share a unique code; both friends get ₹50 after the
/// friend's first order. End-to-end loop backed by [ReferralService].
...
class _ReferEarnScreenState extends State<ReferEarnScreen> {
  ...
  void _share() {
    if (_code == null) return;
    Share.share(_shareMessage, subject: 'Get ₹50 off at Fufaji\'s Online!');
  }
  ...
  Widget _buildHowItWorks() {
    final steps = [
      ('1', Icons.share_rounded, 'Share your code', 'Send your code to friends and family on WhatsApp.'),
      ('2', Icons.person_add_alt_1_rounded, 'They sign up', 'Your friend enters your code while creating their account.'),
      ('3', Icons.celebration_rounded, 'You both earn ₹50', 'When they complete their first order, ₹50 lands in each wallet.'),
    ];
    return Container(
      padding: const EdgeInsets.all(18),
      decoration: BoxDecoration(
  ...
  Widget _buildFriendsList() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Friends you invited',
              style: TextStyle(
                  fontSize: 15,
                  fontWeight: FontWeight.bold,
                  color: AppTheme.grey900)),
...
/// A dashed-border box that shows the referral code with a tap-to-copy icon.
