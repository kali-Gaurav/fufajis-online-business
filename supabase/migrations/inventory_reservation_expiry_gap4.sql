...
-- ============================================================================
-- TIER 6: SCHEDULING (pg_cron)
-- ============================================================================

-- Note: These require pg_cron extension
-- Run every 3 minutes to release expired reservations
-- SELECT cron.schedule('release-expired-inventories', '*/3 * * * *', 'SELECT release_expired_reservations();');

-- Run every 1 hour to cleanup old (consumed/released) reservations (30+ days old)
